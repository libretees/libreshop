    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('setting', models.CharField(blank=True, max_length=128, null=True)),
                ('drop_shipment_setting', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.DropShipmentSetting')),
            ],
        ),
        migrations.CreateModel(
            name='Manufacturer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drop_shipment_settings', models.ManyToManyField(blank=True, through='products.DropShipmentSettingValue', to='products.DropShipmentSetting')),
        ...
        migrations.AlterUniqueTogether(
            name='dropshipmentsettingvalue',
            unique_together=set([('variant', 'drop_shipment_setting')]),
        ),
        migrations.AlterUniqueTogether(
            name='dropshipmentsetting',
